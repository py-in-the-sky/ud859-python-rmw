 ...
 * @type {string}
 */
google.appengine.samples.hello.CLIENT_ID = '523227726521-637qbtq09disuhn3e8d5tor1hf89hfjh.apps.googleusercontent.com';

/**
 * Scopes used by the application.
 * @type {string}
 */
google.appengine.samples.hello.SCOPES = 'https://www.googleapis.com/auth/userinfo.email';
 ...
 * @param {string} times Number of times to repeat it.
 */
